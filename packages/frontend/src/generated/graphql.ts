...
export function useUpdateTicketMutation() {
    return Urql.useMutation<UpdateTicketMutation, UpdateTicketMutationVariables>(
...
export function useDeleteTicketMutation() {
    return Urql.useMutation<DeleteTicketMutation, DeleteTicketMutationVariables>(
...
export function useGetUserTicketsQuery(
    options?: Omit<Urql.UseQueryArgs<GetUserTicketsQueryVariables>, 'query'>
) {
    return Urql.useQuery<GetUserTicketsQuery, GetUserTicketsQueryVariables>({
        query: GetUserTicketsDocument,
        ...options,
    })
}
...
export function useGetTicketsQuery(
    options?: Omit<Urql.UseQueryArgs<GetTicketsQueryVariables>, 'query'>
) {
    return Urql.useQuery<GetTicketsQuery, GetTicketsQueryVariables>({
...
export function useGetTicketQuery(
    options: Omit<Urql.UseQueryArgs<GetTicketQueryVariables>, 'query'>
) {
    return Urql.useQuery<GetTicketQuery, GetTicketQueryVariables>({
